"""green_mail_proj URL Configuration
...
urlpatterns = [
    ...
    path('email/<int:message_id>/rsa/generatepair/', views.generate_rsa_key_pair),
    ...
    # path('email/<int:num>/<str:pub_key>/<str:priv_key>/', views.show, name='show'),
